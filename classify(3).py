...
path=('../ai_pro/VOCdevkit/VOC2010/resized')  #path of resized images
p1=('../ai_pro/VOCdevkit/VOC2010/cnnpro')
p2=('../ai_pro/VOCdevkit/VOC2010/val')
...
n=150
classes=os.listdir(p1)
im = Image.open('/root/Desktop/kit.jpg');
imrs = im.resize((m,n))
imrs=img_to_array(imrs)/255;
imrs=imrs.transpose(2,0,1);
imrs=imrs.reshape(3,m,n);
...
im=Image.open('/root/Desktop/index.jpg');
im=im.convert(mode='RGB')
imrs=im.resize((m,n))
imrs=img_to_array(imrs)/255;
#print(imrs)
